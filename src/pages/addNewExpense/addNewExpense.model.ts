...
export interface IAddNewExpenseFormReducerIntialState {
  ...
  expenseClaimViolationCheckerData: any;
  expenseClaimViolationFetchedDataLoader: boolean;
  violationModalData: any;
  ...
  expenseEntitlement: any;
  taxPercentage: any;
  taxPercentageChange: any;
  getFormDataCalled: any;
  taxPercentageStatus: any;
}
...
export interface IformData {
  ...
  allowance_form: IallowanceFormData;
}
...
export interface IallowanceFormData {
  allowance_records: IallowanceRecords[];
}

export interface IallowanceRecords {
  id?: number;
  expense_type_legal_entity?: number;
  receipt_number?: string;
  allowance_rate?: { id: number; subrate_title: string };
  ...
  amount: number;
  conversion_rate: number | null; //1
  converted_amount: number | null; //100
  system_conversion_rate: number | null;
}
...
export interface IgetAllowanceRateProps {
  date?: string;
  location?: string;
  employee_id?: number;
}
...
export interface IupdateFormDataReturn {
  type:
    ...
    | typeof ADD_NEW_EXPENSES_ACTIONS.UPDATE_ALLOWANCE_FORM;
  payload: any;
}
...
export interface IsetAllowanceRateReturn {
  type: typeof ADD_NEW_EXPENSES_ACTIONS.SET_ALLOWANCE_RATE;
  payload: any;
}

export type TsetMileageRateFn = (rate: number) => IsetMileageRateReturn;

export type TsetAllowanceRateFn = (data: any) => IsetAllowanceRateReturn;
