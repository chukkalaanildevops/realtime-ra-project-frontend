...
import { initialState } from '../../../expenseTypeConfiguration.reducer';
...
const TitleUpdaterDrawer: FC<{
  ...
  backendError: IBackendErrors;
  _setTitleUpdateConfigData: (data: ITitleUpdateConfigData) => void;
  _updateTitleAndCode: (
    id: number,
    data: ITitleAndCode,
